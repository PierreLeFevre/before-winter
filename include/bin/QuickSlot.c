...
void QuickSlotHandeling(Player *player)
{
    ...
    {
        player->ent.items[9].d.destrect.x = player->activeItem.d.destrect.x;
        player->ent.items[9].d.destrect.y = player->activeItem.d.destrect.y;
        player->activeItem = player->ent.items[9];
        player->activeItemIndex = 9;
    }
}